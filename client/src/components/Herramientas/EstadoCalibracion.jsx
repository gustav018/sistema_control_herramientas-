        ...
        axios.put(`https://sistemacontrolherramientas-production.up.railway.app/api/herramienta/${id}`, herramienta, { withCredentials: true })
            .then(res => {
                ...
                Swal.fire({
                    icon: "success",
                    title: "Actualizado!",
                    text: "Herramienta enviada a calibración!!",
                });
                navigate("/sistema/herramientas/vencidas")
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group row">
                        <div className="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" className="form-control form-control-user" id="calibradoPor" placeholder="Calibrado Por" name="calibradoPor" value={herramienta.calibradoPor} onChange={handleChange} required minLength={3} disabled />
                        </div>
                        <div className="col-sm-6">
                            <label htmlFor="certificado">Certificado</label>
                            <input type="text" className="form-control form-control-user" id="certificado" placeholder="Certificado" name="certificado" value={herramienta.certificado} onChange={handleChange} required minLength={3} disabled />
                        </div>
                    </div>
                    <div className="form-group row">
                    ...
                    <div className="form-group row">
                        <div className="col-sm-6">
                            ...
                            <input type="date" className="form-control form-control-user" id="ultimaCalibracion" placeholder="Fecha de Ultima Calibración" name="ultimaCalibracion" value={herramienta.ultimaCalibracion} onChange={handleChange} disabled required />

                        </div>

                        <div className="col-sm-6">
                            <label htmlFor="proximaCalibracion"> Proximo Calibración </label>
                            <input type="date" className="form-control " id="proximaCalibracion" placeholder="Fecha de Proximo Calibración" name="proximaCalibracion" value={herramienta.proximaCalibracion} onChange={handleChange} disabled required />
                        </div>
                    </div>
...
export default EstadoCalibracion
