    ...
    return (
        <>
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <NavLink to="/sistema/herramientas/reporte" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" rel="noopener noreferrer"><i className="fas fa-download fa-sm text-white-50" /> Generar Reporte ISO</NavLink>
            </div>
            <div className="row">
